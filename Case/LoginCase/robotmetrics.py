...
logo = "https://media.licdn.com/dms/image/C4E0BAQHdpglkYA1LCg/company-logo_200_200/0?e=2159024400&v=beta&t=CBZJbQM8Xu9H_zOJaGWPYzKGV-Mzq2c5EDzRYshw1So"
...
<div class="loader"></div>
 <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block bg-white sidebar" style="font-size:16px;">
				...
				<h6 class="sidebar-heading d-flex justify-content-between align-items-center text-muted">
					...
					<h6 class="sidebar-heading d-flex justify-content-between align-items-center text-muted">
                        <span>DGL Project Automate</span>
                        <a class="d-flex align-items-center text-muted" href="#"></a>
                    </h6>
                </div>
            </nav>
